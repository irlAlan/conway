...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "release-2.28.3"
  WORKING_DIRECTORY "/home/alan/top_secret/cpp/SDL2/conway/build/_deps/sdl2-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "release-2.28.3")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("release-2.28.3" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/release-2.28.3")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"release-2.28.3\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/alan/top_secret/cpp/SDL2/conway/build/_deps/sdl2-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/alan/top_secret/cpp/SDL2/conway/build/_deps/sdl2-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
